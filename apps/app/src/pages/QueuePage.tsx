    ...
    <div ref={setNodeRef} style={style} className="bg-surface-raised border border-border rounded-xl overflow-hidden">
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <button
          ...
          className="text-sm px-3 py-1 bg-accent-solid text-on-accent rounded-lg hover:opacity-90 whitespace-nowrap"
        >
          Start session
        </button>
      </div>
        ...
        <div className="border-t border-border">
          {selectedIds.size > 0 && (
            <div className="px-4 py-2 bg-accent/5 border-b border-border flex items-center justify-between">
              ...
              <button onClick={onMarkKnown} className="text-sm px-3 py-1 bg-accent-solid text-on-accent rounded-lg hover:opacity-90">
                Mark as Known
              </button>
            </div>
          )}
